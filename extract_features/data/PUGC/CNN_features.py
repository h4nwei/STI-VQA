...
def main(dataset, features_folder):
    ...
    for i in range(len(dataset)):
        ...
        saved_name = os.path.join(features_folder, video_name.split('/')[1])
...
if __name__ == "__main__":
    ...
    features_folder = r'/home/zhw/vqa/dataset/PUGC/feature/VSFA_resnetxt101_iqapretrain_ms'
    video_folder = r'/data/zhw/PUGC/videos'
    csv_file = Path('/data/zhw/PUGC/PUGC_all.csv')
    ...
    for index, exist_name in enumerate(os.listdir(features_folder)):
        ...
        video_moses.pop(ind)
        sub_video_names.remove(exist_name[:-4])
    video_names = []
