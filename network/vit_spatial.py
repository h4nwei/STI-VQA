...
class ViT(nn.Module):
    def __init__(self, *, input_dim=4096, mlp_dim=128, dim_head=64, output_channel=1, depth=5, heads=6, pool = 'reg', dropout = 0.1, emb_dropout = 0.1, max_length=1000):
        ...
        self.reduce_embedding_0 = nn.Linear(512, mlp_dim, bias=False)
        self.reduce_embedding_1 = nn.Linear(1024, mlp_dim, bias=False)
        self.reduce_embedding_2 = nn.Linear(2048, mlp_dim, bias=False)
        self.reduce_embedding_3 = nn.Linear(4096, mlp_dim, bias=False)
